...
public class testWorld extends World
{
    ...
    public testWorld(int XValue, int YValue, int numberOfSages, int numberOfPredatorSages, int numberOfBerries)//second constructor
    {    
        ...
        //creatures
       for(int i = 0; i < numberOfSages; i++)
        {
            addCreatureSage();
        }
        
        for(int i = 0; i < numberOfPredatorSages; i++)
        {
            addCreaturePredatorSage();
        }
        //berry
        ...
        public void addfood() 
    {
        ...
        addObject(food, randomRange(0,getWidth()), randomRange(0,  getHeight()  )  );
    }
}
